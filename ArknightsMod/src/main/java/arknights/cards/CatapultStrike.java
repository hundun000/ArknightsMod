...
public class CatapultStrike extends ArknightsModCard {
    ...
    public void use(AbstractPlayer player, AbstractMonster monster) {
        addToBot(new BlastDamageAllEnemiesAction(player, monster, magicNumber/100, multiDamage, damageTypeForTurn, AbstractGameAction.AttackEffect.SLASH_HORIZONTAL));
    }
