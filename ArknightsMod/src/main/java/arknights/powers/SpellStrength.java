 ...
 */
public class SpellStrength extends AbstractPower {
    public AbstractCreature source;

    public static final String POWER_ID = ArknightsMod.makeID(SpellStrength.class);
    ...
    public SpellStrength(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public float atDamageGive(float damage, DamageType type, AbstractCard card) {
        float temp = super.atDamageGive(damage, type, card);
