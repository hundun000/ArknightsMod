...
public class RarePower extends AbstractPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(DefaultMod.IMAGES_FOLDER + "/powers/placeholder_power84.png");
    private static final Texture tex32 = TextureLoader.getTexture(DefaultMod.IMAGES_FOLDER + "/powers/placeholder_power32.png");
